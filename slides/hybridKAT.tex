...
\begin{itemize}
\item benefit from huge, impressive libraries of topology, analysis, ODEs;
\item based on $\MKA$;
...
\begin{itemize}
\item Hoare logic is enough for verification condition generation, and
\item Morgan's refinement calculus suffices for program construction.
\end{itemize}
\end{itemize}
\vspace{\baselineskip}
\begin{center}
\comcol{Do Hoare logic and refinement calculus suffice for hybrid program verification?}
\end{center}
\end{frame}
