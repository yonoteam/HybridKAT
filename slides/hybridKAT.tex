...
\begin{enumerate}
\item rules of differential Hoare logic $\dH$ based on $\KAT$;
\item laws of differential refinement calculus $\dR$ based on $\rKAT$;
\item integration of lenses as the store model;
\item support invariant reasoning in the style of differential dynamic logic $\dL$, and
