...
conditions are discharged using Isabelle's impressive components for
ordinary differential equations~\cite{ImmlerH12a}.
...
\ \ \isactrlbold {\isacharbraceleft}I\ T\isactrlsub m\ T\isactrlsub M\isactrlbold {\isacharbraceright}\isanewline
\ \ \ \ therm\ T\isactrlsub m\ T\isactrlsub M\ a\ L\ {\isasymtau}\isanewline
\ \ \isactrlbold {\isacharbraceleft}I\ T\isactrlsub m\ T\isactrlsub M\isactrlbold {\isacharbraceright}{\isachardoublequoteclose}\isanewline
...
\ \ \isakeyword{where}\ {\isachardoublequoteopen}G\ Hm\ k\ {\isasymequiv}\ U{\isacharparenleft}t\ {\isasymle}\ {\isacharparenleft}Hm\ {\isacharminus}\ h\isactrlsub {\isadigit{0}}{\isacharparenright}{\isacharslash}k{\isacharparenright}{\isachardoublequoteclose}\isanewline
\isanewline
\isacommand{abbreviation}\isamarkupfalse%
...
\ \ \isakeyword{shows}\ {\isachardoublequoteopen}\isanewline
\ \ \isactrlbold {\isacharbraceleft}I\ h\isactrlsub m\ h\isactrlsub M\isactrlbold {\isacharbraceright}\isanewline
\ \ \ \ tank{\isacharunderscore}dinv\ c\isactrlsub i\ c\isactrlsub o\ h\isactrlsub m\ h\isactrlsub M\ {\isasymtau}\ \isanewline
\ \ \isactrlbold {\isacharbraceleft}I\ h\isactrlsub m\ h\isactrlsub M\isactrlbold {\isacharbraceright}{\isachardoublequoteclose}\isanewline
...
\ \ {\isachardoublequoteopen}Ref\ {\isasymlceil}I\ Tmin\ Tmax{\isasymrceil}\ {\isasymlceil}U{\isacharparenleft}I\ Tmin\ Tmax\ {\isasymand}\ t\ {\isacharequal}\ {\isadigit{0}}\ {\isasymand}\ T\isactrlsub {\isadigit{0}}\ {\isacharequal}\ T{\isacharparenright}{\isasymrceil}\ {\isasymge}\isanewline
...
\ \ \ {\isacharparenleft}IF\ U{\isacharparenleft}{\isasymTheta}\ {\isacharequal}\ {\isadigit{0}}\ {\isasymand}\ T\isactrlsub {\isadigit{0}}\ {\isasymle}\ Tmin\ {\isacharplus}\ {\isadigit{1}}{\isacharparenright}\ THEN\ {\isacharparenleft}{\isasymTheta}\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isadigit{1}}{\isacharparenright}\ ELSE\isanewline 
\ \ \ \ IF\ U{\isacharparenleft}{\isasymTheta}\ {\isacharequal}\ {\isadigit{1}}\ {\isasymand}\ T\isactrlsub {\isadigit{0}}\ {\isasymge}\ Tmax\ {\isacharminus}\ {\isadigit{1}}{\isacharparenright}\ THEN\ {\isacharparenleft}{\isasymTheta}\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isadigit{0}}{\isacharparenright}\ ELSE\ skip{\isacharparenright}{\isachardoublequoteclose}\isanewline
...
\ \ \isakeyword{shows}\ {\isachardoublequoteopen}Ref\ {\isasymlceil}U{\isacharparenleft}I\ Tmin\ Tmax\ {\isasymand}\ t\ {\isacharequal}\ {\isadigit{0}}\ {\isasymand}\ T\isactrlsub {\isadigit{0}}\ {\isacharequal}\ T{\isacharparenright}{\isasymrceil}\ {\isasymlceil}I\ Tmin\ Tmax{\isasymrceil}\ {\isasymge}\ \isanewline
\ \ {\isacharparenleft}IF\ U{\isacharparenleft}{\isasymTheta}\ {\isacharequal}\ {\isadigit{0}}{\isacharparenright}\ THEN\ \isanewline
\ \ \ \ {\isacharparenleft}x{\isasymacute}{\isacharequal}\ {\isasymlbrakk}f\ a\ {\isadigit{0}}{\isasymrbrakk}\isactrlsub e\ {\isacharampersand}\ G\ Tmin\ Tmax\ a\ {\isadigit{0}}\ on\ {\isacharbraceleft}{\isadigit{0}}{\isachardot}{\isachardot}{\isasymtau}{\isacharbraceright}\ UNIV\ {\isacharat}\ {\isadigit{0}}{\isacharparenright}\ \isanewline
\ \ ELSE\ \isanewline
\ \ \ \ {\isacharparenleft}x{\isasymacute}{\isacharequal}\ {\isasymlbrakk}f\ a\ L{\isasymrbrakk}\isactrlsub e\ {\isacharampersand}\ G\ Tmin\ Tmax\ a\ L\ on\ {\isacharbraceleft}{\isadigit{0}}{\isachardot}{\isachardot}{\isasymtau}{\isacharbraceright}\ UNIV\ {\isacharat}\ {\isadigit{0}}{\isacharparenright}{\isacharparenright}{\isachardoublequoteclose}\isanewline
\isacommand{apply}\isamarkupfalse%
...
\ \ \ \ Ref\ {\isasymlceil}I\ Tmin\ Tmax{\isasymrceil}\ {\isasymlceil}U{\isacharparenleft}I\ Tmin\ Tmax\ {\isasymand}\ t\ {\isacharequal}\ {\isadigit{0}}\ {\isasymand}\ T\isactrlsub {\isadigit{0}}\ {\isacharequal}\ T{\isacharparenright}{\isasymrceil}{\isacharsemicolon}\isanewline
\ \ \ \ Ref\ {\isasymlceil}U{\isacharparenleft}I\ Tmin\ Tmax\ {\isasymand}\ t\ {\isacharequal}\ {\isadigit{0}}\ {\isasymand}\ T\isactrlsub {\isadigit{0}}\ {\isacharequal}\ T{\isacharparenright}{\isasymrceil}\ {\isasymlceil}I\ Tmin\ Tmax{\isasymrceil}\isanewline
...
\ \ \ \ {\isacharparenleft}t\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isadigit{0}}{\isacharparenright}{\isacharsemicolon}\ {\isacharparenleft}T\isactrlsub {\isadigit{0}}\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ T{\isacharparenright}{\isacharsemicolon}\isanewline
\ \ \ \ {\isacharparenleft}IF\ U{\isacharparenleft}{\isasymTheta}\ {\isacharequal}\ {\isadigit{0}}\ {\isasymand}\ T\isactrlsub {\isadigit{0}}\ {\isasymle}\ Tmin\ {\isacharplus}\ {\isadigit{1}}{\isacharparenright}\ THEN\ {\isacharparenleft}{\isasymTheta}\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isadigit{1}}{\isacharparenright}\ ELSE\isanewline 
\ \ \ \ \ IF\ U{\isacharparenleft}{\isasymTheta}\ {\isacharequal}\ {\isadigit{1}}\ {\isasymand}\ T\isactrlsub {\isadigit{0}}\ {\isasymge}\ Tmax\ {\isacharminus}\ {\isadigit{1}}{\isacharparenright}\ THEN\ {\isacharparenleft}{\isasymTheta}\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isadigit{0}}{\isacharparenright}\ ELSE\ skip{\isacharparenright}{\isacharsemicolon}\isanewline
\ \ \ \ %
\isamarkupcmt{dynamics%
}\isanewline
\ \ \ \ {\isacharparenleft}IF\ U{\isacharparenleft}{\isasymTheta}\ {\isacharequal}\ {\isadigit{0}}{\isacharparenright}\ THEN\ {\isacharparenleft}x{\isasymacute}{\isacharequal}\ {\isasymlbrakk}f\ a\ {\isadigit{0}}{\isasymrbrakk}\isactrlsub e\ {\isacharampersand}\ G\ Tmin\ Tmax\ a\ {\isadigit{0}}\ on\ {\isacharbraceleft}{\isadigit{0}}{\isachardot}{\isachardot}{\isasymtau}{\isacharbraceright}\ UNIV\ {\isacharat}\ {\isadigit{0}}{\isacharparenright}\ \isanewline
\ \ \ \ ELSE\ {\isacharparenleft}x{\isasymacute}{\isacharequal}\ {\isasymlbrakk}f\ a\ L{\isasymrbrakk}\isactrlsub e\ {\isacharampersand}\ G\ Tmin\ Tmax\ a\ L\ on\ {\isacharbraceleft}{\isadigit{0}}{\isachardot}{\isachardot}{\isasymtau}{\isacharbraceright}\ UNIV\ {\isacharat}\ {\isadigit{0}}{\isacharparenright}{\isacharparenright}\isanewline
...
\ \ {\isachardoublequoteopen}{\isadigit{0}}\ {\isasymle}\ {\isasymtau}\ {\isasymLongrightarrow}\ diff{\isacharunderscore}invariant\ \ {\isasymlbrakk}dI\ hmin\ hmax\ k{\isasymrbrakk}\isactrlsub e\ {\isasymlbrakk}f\ k{\isasymrbrakk}\isactrlsub e\ {\isacharbraceleft}{\isadigit{0}}{\isachardot}{\isachardot}{\isasymtau}{\isacharbraceright}\ UNIV\ {\isadigit{0}}\ Guard{\isachardoublequoteclose}\isanewline
\ \ $\langle \isa{proof}\rangle$\isanewline
\isanewline
\isacommand{lemma}\isamarkupfalse%
...
\ \ \ \ {\isacharparenleft}{\isacharparenleft}t\ {\isacharcolon}{\isacharcolon}{\isacharequal}{\isadigit{0}}{\isacharparenright}{\isacharsemicolon}{\isacharparenleft}h\isactrlsub {\isadigit{0}}\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ h{\isacharparenright}{\isacharsemicolon}\isanewline
\ \ \ \ {\isacharparenleft}IF\ U{\isacharparenleft}Pump\ {\isacharequal}\ {\isadigit{0}}\ {\isasymand}\ h\isactrlsub {\isadigit{0}}\ {\isasymle}\ hmin\ {\isacharplus}\ {\isadigit{1}}{\isacharparenright}\ THEN\ {\isacharparenleft}Pump\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isadigit{1}}{\isacharparenright}\ ELSE\ \isanewline
\ \ \ \ {\isacharparenleft}IF\ U{\isacharparenleft}Pump\ {\isacharequal}\ {\isadigit{1}}\ {\isasymand}\ h\isactrlsub {\isadigit{0}}\ {\isasymge}\ hmax\ {\isacharminus}\ {\isadigit{1}}{\isacharparenright}\ THEN\ {\isacharparenleft}Pump\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isadigit{0}}{\isacharparenright}\ ELSE\ skip{\isacharparenright}{\isacharparenright}{\isacharsemicolon}\isanewline
\ \ \ \ %
\isamarkupcmt{dynamics%
}\isanewline
\ \ \ \ {\isacharparenleft}IF\ U{\isacharparenleft}Pump\ {\isacharequal}\ {\isadigit{0}}{\isacharparenright}\ THEN\ \isanewline
\ \ \ \ \ \ {\isacharparenleft}x{\isasymacute}{\isacharequal}\ {\isasymlbrakk}f\ {\isacharparenleft}c\isactrlsub i{\isacharminus}c\isactrlsub o{\isacharparenright}{\isasymrbrakk}\isactrlsub e\ {\isacharampersand}\ G\ hmax\ {\isacharparenleft}c\isactrlsub i{\isacharminus}c\isactrlsub o{\isacharparenright}\ on\ {\isacharbraceleft}{\isadigit{0}}{\isachardot}{\isachardot}{\isasymtau}{\isacharbraceright}\ UNIV\ {\isacharat}\ {\isadigit{0}}\isanewline 
...
\ {\isacharquery}Icntrl\ {\isacharequal}\ {\isachardoublequoteopen}U{\isacharparenleft}I\ hmin\ hmax\ {\isasymand}\ t\ {\isacharequal}\ {\isadigit{0}}\ {\isasymand}\ h\isactrlsub {\isadigit{0}}\ {\isacharequal}\ h{\isacharparenright}{\isachardoublequoteclose}\ $\langle \dots\rangle$\isanewline
...
\ \ \isactrlbold {\isacharbraceleft}x\ {\isacharequal}\ h\ {\isasymand}\ v\ {\isacharequal}\ {\isadigit{0}}\isactrlbold {\isacharbraceright}\ \isanewline
\ \ {\isacharparenleft}LOOP\ \isanewline
\ \ \ \ \ \ {\isacharparenleft}{\isacharparenleft}EVOL\ {\isacharparenleft}{\isasymphi}\ g{\isacharparenright}\ U{\isacharparenleft}x\ {\isasymge}\ {\isadigit{0}}{\isacharparenright}\ T{\isacharparenright}{\isacharsemicolon}\isanewline
\ \ \ \ \ \ \ {\isacharparenleft}IF\ U{\isacharparenleft}v\ {\isacharequal}\ {\isadigit{0}}{\isacharparenright}\ THEN\ {\isacharparenleft}v\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isacharminus}v{\isacharparenright}\ ELSE\ skip{\isacharparenright}{\isacharparenright}\ \isanewline
\ \ \ \ INV\ U{\isacharparenleft}{\isadigit{0}}\ {\isasymle}\ x\ {\isasymand}\ {\isadigit{2}}\ {\isasymcdot}\ g\ {\isasymcdot}\ x\ {\isacharequal}\ {\isadigit{2}}\ {\isasymcdot}\ g\ {\isasymcdot}\ h\ {\isacharplus}\ v\ {\isasymcdot}\ v{\isacharparenright}\isanewline
\ \ {\isacharparenright}\ \isactrlbold {\isacharbraceleft}{\isadigit{0}}\ {\isasymle}\ x\ {\isasymand}\ x\ {\isasymle}\ h\isactrlbold {\isacharbraceright}{\isachardoublequoteclose}\isanewline
\isacommand{apply}\isamarkupfalse%
...
\ \ \ \ \ \isacommand{apply}\isamarkupfalse%
{\isacharparenleft}simp{\isacharcomma}\ pred{\isacharunderscore}simp{\isacharcomma}\ force\ simp{\isacharcolon}\ bb{\isacharunderscore}real{\isacharunderscore}arith{\isacharparenright}\isanewline
\ \ \ \ \isacommand{apply}\isamarkupfalse%
{\isacharparenleft}simp{\isacharcomma}\ pred{\isacharunderscore}simp{\isacharparenright}{\isacharplus}\isanewline
\ \ \isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}force\ simp{\isacharcolon}\ bb{\isacharunderscore}real{\isacharunderscore}arith{\isacharparenright}\isanewline
\isanewline
\isacommand{lemma}\isamarkupfalse%
...
\ \ \isakeyword{shows}\ {\isachardoublequoteopen}Ref\ {\isasymlceil}U{\isacharparenleft}x\ {\isacharequal}\ h\ {\isasymand}\ v\ {\isacharequal}\ {\isadigit{0}}{\isacharparenright}{\isasymrceil}\ {\isasymlceil}U{\isacharparenleft}{\isadigit{0}}\ {\isasymle}\ x\ {\isasymand}\ x\ {\isasymle}\ h{\isacharparenright}{\isasymrceil}\ {\isasymge}\ \isanewline
\ \ {\isacharparenleft}LOOP\ \isanewline
\ \ \ \ \ \ {\isacharparenleft}{\isacharparenleft}EVOL\ {\isacharparenleft}{\isasymphi}\ g{\isacharparenright}\ U{\isacharparenleft}x\ {\isasymge}\ {\isadigit{0}}{\isacharparenright}\ T{\isacharparenright}{\isacharsemicolon}\isanewline
\ \ \ \ \ \ \ {\isacharparenleft}IF\ U{\isacharparenleft}v\ {\isacharequal}\ {\isadigit{0}}{\isacharparenright}\ THEN\ {\isacharparenleft}v\ {\isacharcolon}{\isacharcolon}{\isacharequal}\ {\isacharminus}v{\isacharparenright}\ ELSE\ skip{\isacharparenright}{\isacharparenright}\ \isanewline
\ \ \ \ INV\ U{\isacharparenleft}{\isadigit{0}}\ {\isasymle}\ x\ {\isasymand}\ {\isadigit{2}}\ {\isasymcdot}\ g\ {\isasymcdot}\ x\ {\isacharequal}\ {\isadigit{2}}\ {\isasymcdot}\ g\ {\isasymcdot}\ h\ {\isacharplus}\ v\ {\isasymcdot}\ v{\isacharparenright}{\isacharparenright}{\isachardoublequoteclose}\isanewline
\ \ $\langle \isa{\dots}\rangle$\ \isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}rule\ R{\isacharunderscore}g{\isacharunderscore}evol{\isacharunderscore}rule{\isacharcomma}\ pred{\isacharunderscore}simp{\isacharcomma}\ force\ simp{\isacharcolon}\ bb{\isacharunderscore}real{\isacharunderscore}arith{\isacharparenright}\isanewline
\end{isabellebody}
