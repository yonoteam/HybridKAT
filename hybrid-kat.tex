...
description of the store between those programs as an Isabelle/UTP
expression~\cite{FosterZW16}, denoted by the $\isactrlU(-)$
quotation. Lemma \isa{local-flow-therm}, whose proof captures the
procedure described above, supplies the flow for $f\, a\, c$:
